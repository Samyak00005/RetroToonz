...
export default function SearchBar({ compact = false, autoFocus = false }) {
  ...
  return (
    ...
    >
      <div className="relative flex w-full items-center rounded-3xl border-[0.5px] border-white/10 bg-black/10 p-1 backdrop-blur-xl backdrop-saturate-150 transition focus-within:border-cyan-300/25 focus-within:bg-black/20">
        <HugeiconsIcon
          icon={Search01Icon}
          size={17}
